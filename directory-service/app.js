...
[
  ...
  new Question("Что понимают под управлением компьютерной сетью?", 
  [
    new Answer("поддержание её в работоспособном состоянии", 0),
    new Answer("автоматизация процессов контроля и настройки параметров", 0),
    new Answer("поддержание соответствующего уровня производительности", 0),
    new Answer("прогнозирование сбоев и перегрузки", 1),
  ]),
  ...
  [
    ...
    new Answer("протокол TCP/IP 4версии", 1),
  ]),
  ...
  [
    ...
    new Answer("скорость обработки пакетовс", 1),
  ]),
];
